...
function RoomDetailModel({ actionType, currentRoomDetail, roomTypeArray }) {
    ...
    const roomDetailModelSchema = Yup.object().shape({
        ...
        totalRooms: Yup.number().typeError("Please enter only number").positive("Please enter a positive number").integer("Please enter an integer number").required("Please enter total rooms"),
                        ...
                        >
                            ...
                            <Grid xs={12} md={12} >
                                ...
                                <Controller
                                    name='images'
                                    control={control}
                                    defaultValue={currentRoomDetail ? currentRoomDetail.images.map((image) => {
                                        return {
                                            key: image,
                                            url: imageURL + image
                                        }
